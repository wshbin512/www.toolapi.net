...
abstract class BaseController
{
	...
	final private function authorizationDecryptCrmeb(bool $bool = false)
	{
		...
		if (!$authorizationExtacttext || !is_file($authorizationExtacttext)) {
			throw new \RuntimeException('授权文件丢书', 42006);
		}
	...
	final protected function getAuth()
	{
		...
		if (!$auth) {
			$res = \crmeb\services\HttpService::postRequest('http://shop.crmeb.net/auth/business/auth', ['domain' => 'pro.lfmn.fun', 'version' => get_crmeb_version()]);
