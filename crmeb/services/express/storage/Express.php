...
class Express extends BaseExpress
{
    ...
    public function dump($data)
    {
        ...
        if (isset($data['partner_id'])) $param['partner_id'] = $data['partner_id'];
        if (isset($data['partner_key'])) $param['partner_key'] = $data['partner_key'];
        if (isset($data['net'])) $param['net'] = $data['net'];
