...
class UserBillServices extends BaseServices
{
    ...
    public function getBrokerageList(int $uid = 0, $where_time = [], string $field = '*')
    {
        ...
        $where = ['category' => 'now_money', 'type' => ['pay_money', 'system_add', 'pay_product_refund', 'pay_member', 'offline_scan', 'system_sub', 'recharge']];
        if ($uid) $where['uid'] = $uid;
        if ($where_time) $where['add_time'] = $where_time;
     ...
     * @throws Exception
     */
    public function incomeCoinMoney(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
     ...
     * @throws Exception
     */
    public function incomeShopping(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
     ...
     * @throws Exception
     */
    public function expendShopping(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'shopping';
        $data['type'] = $type;
     ...
     * @throws Exception
     */
    public function incomeRed(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'coupon_red';
        $data['type'] = $type;
        $data['pm'] = 1;
        $data['status'] = 1;
        $data['add_time'] = time();
     ...
     * @throws Exception
     */
    public function expendRed(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'coupon_red';
        $data['type'] = $type;
     ...
     * @throws Exception
     */
    public function incomeGreen(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'coupon_green';
        $data['type'] = $type;
        $data['pm'] = 1;
        $data['status'] = 1;
        $data['add_time'] = time();
     ...
     * @throws Exception
     */
    public function expendGreen(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'coupon_green';
        $data['type'] = $type;
     ...
     * @throws Exception
     */
    public function incomeQuicken(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'quicken';
        $data['type'] = $type;
        $data['pm'] = 1;
        $data['status'] = 1;
        $data['add_time'] = time();
     ...
     * @throws Exception
     */
    public function expendQuicken(int $uid, string $type, array $data)
    {
        $data['uid'] = $uid;
        $data['category'] = 'quicken';
        $data['type'] = $type;
    ...
    public function getUserBillList(int $uid, int $type)
    {
        $where = [];
        $where['uid'] = $uid;
        $where['category'] = ['now_money', 'coupon_red', 'coupon_green', 'quicken'];
        switch ((int)$type) {
            case 0:
                $where['type'] = ['recharge', 'pay_money', 'system_add', 'pay_product_refund', 'system_sub', 'pay_member', 'offline_scan', 'mutual_into', 'mutual_out', 'coupon_red', 'coupon_green', 'quicken'];
                break;
            case 1:
            ...
            case 2:
                ...
                break;
            case 3:
                $where['type'] = ['brokerage', 'retreat', 'reward'];
                break;
            case 4:
                $where['type'] = ['extract'];
                break;
