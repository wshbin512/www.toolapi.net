...
Route::group('app', function () {
    ...
    //APP资源路由
    Route::resource('app', 'v1.application.app.AppService')->name('Index');
    //修改APP状态
    Route::put('app/set_status/:id/:status', 'v1.application.app.AppService/set_status')->name('AppStatus');
    //APP列表
    Route::get('app_list', 'v1.application.app.AppService/appList')->name('AppList');
