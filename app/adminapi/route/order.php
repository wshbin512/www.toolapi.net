...
Route::group('order', function () {
    ...
    //批量发货
    Route::get('hand/batch_delivery', 'v1.order.StoreOrder/hand_batch_delivery');
    //自动批量发货
    Route::post('other/batch_delivery', 'v1.order.StoreOrder/other_batch_delivery');
    //订单批量删除
    Route::post('batch/del_orders', 'v1.order.StoreOrder/del_orders');
