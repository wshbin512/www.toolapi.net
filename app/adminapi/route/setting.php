...
Route::group('setting', function () {
    ...
    //区域列表
    Route::get('area', 'v1.setting.SystemArea/index');
    //区域权限列表
    Route::get('area/create', 'v1.setting.SystemArea/create');
    //区域编辑详情
    Route::get('area/:id/edit', 'v1.setting.SystemArea/edit');
    //区域保存新建或编辑
    Route::post('area/:id', 'v1.setting.SystemArea/save');
    //修改区域状态
    Route::put('area/set_status/:id/:status', 'v1.setting.SystemArea/set_status');
    //删除区域
    Route::delete('area/:id', 'v1.setting.SystemArea/delete');
