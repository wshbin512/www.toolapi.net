...
Route::group(function () {
    ...
    Route::post('user/enter', 'v1.user.UserController/enter')->name('enter');//提交申请
    Route::get('user/area', 'v1.user.UserController/area')->name('area');//请求区域信息
    Route::post('change/url', 'v1.user.UserController/save_change_url')->name('changeUrl');//保存用户钱包地址
    Route::post('saveFeedback', 'v1.user.UserController/saveFeedback')->name('saveFeedback');// 保存意见反馈
    //新增使用次数
    Route::post('user/useNumber', 'v1.user.UserController/useNumber')->name('useNumber');
    Route::get('user/userRegisterNum', 'v1.user.UserController/getUserRegister')->name('getUserRegister');
    //查看H5推广二维码
    Route::get('user/look_h5_code', 'v1.user.UserController/look_h5_code');
    ...
    //活动---拼团
    Route::get('combination/get_my_pink_list', 'v1.activity.StoreCombinationController/get_my_pink_list')->name('getMyPinkList');//我的拼团列表
    Route::get('combination/get_my_pink_data', 'v1.activity.StoreCombinationController/get_my_pink_data')->name('getMyPinkData');//我的拼团统计
    ...
    Route::post('mutual/save', 'v1.user.UserRechargeController/mutual')->name('mutualSave');//资金来往
    Route::post('red_green/turn', 'v1.user.UserRechargeController/red_green_turn')->name('redGreenTurn');//红转绿
    Route::post('green_currency/turn', 'v1.user.UserRechargeController/green_currency_turn')->name('greenCurrencyTurn');//绿转零钱
    Route::post('integral_change/turn', 'v1.user.UserRechargeController/integral_change_turn')->name('integralChangeTurn');//绿转零钱
...
Route::group(function () {
    ...
    Route::get('system', 'v1.PublicController/system')->name('system');//系统
    Route::get('version', 'v1.PublicController/version')->name('version');//版本
    ...
    //请求广告
    Route::get('advertise', 'v1.PublicController/getAdvertise');
    ...
    //电影分类类
    Route::get('video/category', 'v1.video.CategoryController/getList')->name('getList');
    Route::get('video/news', 'v1.video.VideoController/news')->name('news');//每日更新列表
    Route::get('video/best', 'v1.video.VideoController/best')->name('best');//精选影片列表
    Route::get('video/list', 'v1.video.VideoController/list')->name('list');//影片列表
    Route::get('video/detail/:id/[:type]', 'v1.video.VideoController/detail')->name('detail');//影片详情
    ...
    //活动---拼团
    Route::get('combination/community_list', 'v1.activity.StoreCombinationController/community_list')->name('communityList');//拼购列表
