    ...
    <form id="J_install_form" action="index.php?step=4" method="post">
      ...
      <div class="server">
        ...
        <table width="100%">
          ...
          <div class="on-other" style="color: #ccc">多项目部署配置</div>
          <table width="100%" class="other" style="display: none">
<!--              <tr>-->
<!--                  <td class="td1" width="100">多项目部署配置</td>-->
<!--                  <td class="td1" width="200">&nbsp;</td>-->
<!--                  <td class="td1">&nbsp;</td>-->
<!--              </tr>-->
              <tr>
                  <td class="tar">缓存前缀：</td>
                  <td><input type="text" name="cache_prefix" id="cache_prefix" value="" class="input"></td>
                  <td><div id="J_install_tip_manager"></div><span class="gray">多项目部署下可填写不同的缓存前缀，单个项目部署可留空</span></td>
              </tr>
              <tr>
                  <td class="tar">缓存标签前缀：</td>
                  <td><input type="text" name="cache_tag_prefix" id="cache_tag_prefix" class="input" autoComplete="off"></td>
                  <td><div id="J_install_tip_manager_pwd"></div><span class="gray">多项目部署下可填写不同的缓存前缀，单个项目部署可留空</span></td>
              </tr>
              <tr>
                  <td class="tar">workerman后台通讯端口：</td>
                  <td><input type="number" name="workerman_admin_port" value="20002" id="workerman_admin_port" class="input" autoComplete="off"></td>
                  <td><div id="J_install_tip_manager_ckpwd"></div><span class="gray">多项目部署下可填写不同的后台通讯端口，单个项目部署可不填写</span></td>
              </tr>
              <tr>
                  <td class="tar">workerman前台通讯端口：</td>
                  <td><input type="number" name="workerman_chat_port" value="20003" id="workerman_chat_port" class="input" autoComplete="off"></td>
                  <td><div id="J_install_tip_manager_ckpwd"></div><span class="gray">多项目部署下可填写不同的前台通讯端口，单个项目部署可不填写</span></td>
              </tr>
              <tr>
                  <td class="tar">workerman内部通讯端口：</td>
                  <td><input type="number" name="workerman_channel_port"  value="20012" id="workerman_channel_port" class="input" autoComplete="off"></td>
                  <td><div id="J_install_tip_manager_ckpwd"></div><span class="gray">多项目部署下可填写不同的内部通讯端口，单个项目部署可不填写</span></td>
              </tr>
          </table>
